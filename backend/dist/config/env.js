...
exports.env = {
    ...
    SOCKET_ALLOWED_ORIGINS: listFromEnv(process.env.SOCKET_ALLOWED_ORIGINS, isDockerMode ? dockerOrigins : localOrigins),
    ...
    YOUTUBE_USE_CHAT_STREAM: process.env.YOUTUBE_USE_CHAT_STREAM !== undefined
        ? process.env.YOUTUBE_USE_CHAT_STREAM === "true"
        : localConfig.youtube.useChatStream,
    YOUTUBE_CHAT_POLLING_ENABLED: process.env.YOUTUBE_CHAT_POLLING_ENABLED !== undefined
        ? process.env.YOUTUBE_CHAT_POLLING_ENABLED !== "false"
        : localConfig.youtube.chatPollingEnabled,
    YOUTUBE_SUPERCHAT_POLLING_ENABLED: process.env.YOUTUBE_SUPERCHAT_POLLING_ENABLED !== undefined
        ? process.env.YOUTUBE_SUPERCHAT_POLLING_ENABLED !== "false"
        : localConfig.youtube.superchatPollingEnabled,
    YOUTUBE_VIEWER_COUNT_POLLING_ENABLED: process.env.YOUTUBE_VIEWER_COUNT_POLLING_ENABLED !== undefined
        ? process.env.YOUTUBE_VIEWER_COUNT_POLLING_ENABLED !== "false"
        : localConfig.youtube.viewerCountPollingEnabled,
    YOUTUBE_SUBSCRIBER_POLLING_ENABLED: process.env.YOUTUBE_SUBSCRIBER_POLLING_ENABLED !== undefined
        ? process.env.YOUTUBE_SUBSCRIBER_POLLING_ENABLED === "true"
        : localConfig.youtube.subscriberPollingEnabled,
    YOUTUBE_MEMBER_POLLING_ENABLED: process.env.YOUTUBE_MEMBER_POLLING_ENABLED !== undefined
