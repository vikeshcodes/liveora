import type { GoalRecord, OverlayConfig, OverlayRecord, OverlayTokenRecord, SceneRecord, ThemeRecord } from "../types";

export const DEFAULT_WIDGETS: OverlayConfig["widgets"] = {
  alertWidget: {
    enabled: true,
    duration: 5000,
    position: "top-right"
...
export const DEFAULT_OVERLAY: OverlayRecord = {
  id: "main-overlay",
...
export const DEFAULT_TOKEN: OverlayTokenRecord = {
  overlayId: "main-overlay",
